    ...
    <div className="flex md:flex-row flex-col items-center justify-between md:p-10 px-4">
      ...
      <div className="flex-1 flex flex-col justify-start items-center">
        ...
        <ServiceCard
          ...
          subtitle="Access and transact from anywhere at any time given there is internet."
        />
        <ServiceCard
          color="bg-[#F84550]"
          title="Private"
          icon={<RiHeart2Fill fontSize={21} className="text-white" />}
          subtitle="There are no servers keeping user accounts or any kind of identifiers."
        />
      </div>
    </div>
  </div>
